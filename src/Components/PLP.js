  ...
  return (
    <div>
      <div className="container text-center" style={{ marginTop: "100px" }}>
        {/* 🔥 FIX APPLIED HERE:
                    Removed the conflicting Bootstrap classes: 
                    row-cols-2, row-cols-lg-3, g-2, g-lg-3.
                    Only keeping .row and px-4 for padding.
                */}
        <div className="row px-4">

          {products && products.length > 0 ? (
            products.map((product) => (
              <div key={product.id} className="col"> {/* Added key for React performance */}
