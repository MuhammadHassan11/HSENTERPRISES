  ...
  return (
    <div>
      <div class="container text-center" style={{ marginTop: "100px" }}>
        <div class="row row-cols-2 row-cols-lg-3 g-2 g-lg-3 px-4">
          {productList.map((product) => (
            ...
            <div class="col">
              ...
              <div class="card" style={{ width: "18rem" }}>
                <img style={{ height: "250px" }} src={product.Image} class="card-img-top" alt="Rings" />
                <div class="card-body">
                  <h5 class="card-title"><strong>{product.name}</strong></h5>
                  <p class="card-text">{product.description}</p>
                  <Link to="/pdp" state={product} class="btn btn-primary">Read More</Link>
                </div>
              </div>
            </div>
          ))}
          {/* <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img style={{ height: "250px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSO-Dk_mQIcZetfMfAio39xhcWPJz-PSwSGaMr6RmcDCg&s" class="card-img-top" alt="Wallets" />
              <div class="card-body">
                <h5 class="card-title"><b>Leather Wallets</b></h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="/pdp" class="btn btn-primary">Read More</a>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img style={{ height: "250px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAitGhtqs0rAoPGG4jd_kc2xR7U1F5SEyx3g&s" class="card-img-top" alt="Smart Watch" />
              <div class="card-body">
                <h5 class="card-title"><b>Smart Watches</b></h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="/pdp" class="btn btn-primary">Read More</a>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img style={{ height: "250px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTc-33AMR15xZg2EXi-cI_x6EEqcWsXJ1L5QQ&s" class="card-img-top" alt="Tee Shirts" />
              <div class="card-body">
                <h5 class="card-title"><b>Tee Shirts</b></h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="/pdp" class="btn btn-primary">Read More</a>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img style={{ height: "250px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRp2f8hnRe7BLh-mXSHUNFa0Aq7YUhM_WsOw&s" class="card-img-top" alt="Trouser" />
              <div class="card-body">
                <h5 class="card-title"><b>Mens Trouser</b></h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="/pdp" class="btn btn-primary">Read More</a>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img style={{ height: "250px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFkci0NafuRwIz1aUrpo8hyqX3m3Dcr-iMIA&s" class="card-img-top" alt="Bags" />
              <div class="card-body">
                <h5 class="card-title"><b>Bags</b></h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="/pdp" class="btn btn-primary">Read More</a>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img style={{ height: "250px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKgsv4AQWQFYgN4opTE2kOeiDjaNBmSkATsA&s" class="card-img-top" alt="caps" />
              <div class="card-body">
                <h5 class="card-title"><b>Caps</b></h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="/pdp" class="btn btn-primary">Read More</a>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img style={{ height: "250px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWFy8HCWpZJq58F7XFhdsM1DgfozBCcYs2Bg&s" class="card-img-top" alt="Ear Pods" />
              <div class="card-body">
                <h5 class="card-title"><b>Ear Pods</b></h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="/pdp" class="btn btn-primary">Read More</a>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img style={{ height: "250px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0xltOEAr_5joPM3LfRtCasj6fT_teO2Smww&s" class="card-img-top" alt="Bracellet" />
              <div class="card-body">
                <h5 class="card-title"><b>Bracellet</b></h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="/pdp" class="btn btn-primary">Read More</a>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img style={{ height: "250px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBsyuGHW2jwpDzcg7xCtJxpF5h4Szqmht29Q&s" class="card-img-top" alt="Iphones" />
              <div class="card-body">
                <h5 class="card-title"><b>Iphones</b></h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="/pdp" class="btn btn-primary">Read More</a>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img style={{ height: "250px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbgsgCgdM69s7fNfZVf7KOtCatuo3VlX5dtw&s" class="card-img-top" alt="Accessories" />
              <div class="card-body">
                <h5 class="card-title"><b>Mobile Accessories</b></h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="/pdp" class="btn btn-primary">Read More</a>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img style={{ height: "250px" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZR5YbL4QDWxVJprFbmtFjuX5HvGrpE8GcfQ&s" class="card-img-top img-thumbnail" alt="Cases" />
              <div class="card-body">
                <h5 class="card-title"><b>Mobile Cases</b></h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="/pdp" class="btn btn-primary">Read More</a>
              </div>
            </div>
